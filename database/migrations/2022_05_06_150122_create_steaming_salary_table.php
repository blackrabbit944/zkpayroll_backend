...
class CreateSteamingSalaryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('b_steaming_salary', function (Blueprint $table) {
            ...
            $table->integer('during_time')->default(86400)->comment('持续时间unixtime');
    ...
    {
        Schema::dropIfExists('b_steaming_salary');
    }
}